import { Search, Bell, Settings, Sun, Moon, Zap, ExternalLink, LayoutList, LayoutDashboard } from 'lucide-react'
import { useStore } from '@/app/store'

export function TopCommandBar() {
  const { theme, toggleTheme, searchQuery, setSearchQuery, actions, comfortMode, toggleComfortMode } = useStore()
